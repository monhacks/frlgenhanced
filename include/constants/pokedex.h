...
// Hoenn Pokedex order
enum ExpandedKantoDexOrder {
    EXP_KANTO_DEX_NONE,
    EXP_KANTO_DEX_BULBASAUR,
    EXP_KANTO_DEX_IVYSAUR,
    EXP_KANTO_DEX_VENUSAUR,
    EXP_KANTO_DEX_CHARMANDER,
    EXP_KANTO_DEX_CHARMELEON,
    EXP_KANTO_DEX_CHARIZARD,
    EXP_KANTO_DEX_SQUIRTLE,
    EXP_KANTO_DEX_WARTORTLE,
    EXP_KANTO_DEX_BLASTOISE,
    EXP_KANTO_DEX_CATERPIE,
    EXP_KANTO_DEX_METAPOD,
    EXP_KANTO_DEX_BUTTERFREE,
    EXP_KANTO_DEX_WEEDLE,
    EXP_KANTO_DEX_KAKUNA,
    EXP_KANTO_DEX_BEEDRILL,
    EXP_KANTO_DEX_PIDGEY,
    EXP_KANTO_DEX_PIDGEOTTO,
    EXP_KANTO_DEX_PIDGEOT,
    EXP_KANTO_DEX_RATTATA,
    EXP_KANTO_DEX_RATICATE,
    EXP_KANTO_DEX_SPEAROW,
    EXP_KANTO_DEX_FEAROW,
    EXP_KANTO_DEX_EKANS,
    EXP_KANTO_DEX_ARBOK,
    EXP_KANTO_DEX_PICHU,
    EXP_KANTO_DEX_PIKACHU,
    EXP_KANTO_DEX_RAICHU,
    EXP_KANTO_DEX_SANDSHREW,
    EXP_KANTO_DEX_SANDSLASH,
    EXP_KANTO_DEX_NIDORAN_F,
    EXP_KANTO_DEX_NIDORINA,
    EXP_KANTO_DEX_NIDOQUEEN,
    EXP_KANTO_DEX_NIDORAN_M,
    EXP_KANTO_DEX_NIDORINO,
    EXP_KANTO_DEX_NIDOKING,
    EXP_KANTO_DEX_CLEFFA,
    EXP_KANTO_DEX_CLEFAIRY,
    EXP_KANTO_DEX_CLEFABLE,
    EXP_KANTO_DEX_VULPIX,
    EXP_KANTO_DEX_NINETALES,
    EXP_KANTO_DEX_IGGLYBUFF,
    EXP_KANTO_DEX_JIGGLYPUFF,
    EXP_KANTO_DEX_WIGGLYTUFF,
    EXP_KANTO_DEX_ZUBAT,
    EXP_KANTO_DEX_GOLBAT,
    EXP_KANTO_DEX_CROBAT,
    EXP_KANTO_DEX_ODDISH,
    EXP_KANTO_DEX_GLOOM,
    EXP_KANTO_DEX_VILEPLUME,
    EXP_KANTO_DEX_BELLOSSOM,
    EXP_KANTO_DEX_PARAS,
    EXP_KANTO_DEX_PARASECT,
    EXP_KANTO_DEX_VENONAT,
    EXP_KANTO_DEX_VENOMOTH,
    EXP_KANTO_DEX_DIGLETT,
    EXP_KANTO_DEX_DUGTRIO,
    EXP_KANTO_DEX_MEOWTH,
    EXP_KANTO_DEX_PERSIAN,
    EXP_KANTO_DEX_PSYDUCK,
    EXP_KANTO_DEX_GOLDUCK,
    EXP_KANTO_DEX_MANKEY,
    EXP_KANTO_DEX_PRIMEAPE,
    EXP_KANTO_DEX_GROWLITHE,
    EXP_KANTO_DEX_ARCANINE,
    EXP_KANTO_DEX_POLIWAG,
    EXP_KANTO_DEX_POLIWHIRL,
    EXP_KANTO_DEX_POLIWRATH,
    EXP_KANTO_DEX_POLITOED,
    EXP_KANTO_DEX_ABRA,
    EXP_KANTO_DEX_KADABRA,
    EXP_KANTO_DEX_ALAKAZAM,
    EXP_KANTO_DEX_MACHOP,
    EXP_KANTO_DEX_MACHOKE,
    EXP_KANTO_DEX_MACHAMP,
    EXP_KANTO_DEX_BELLSPROUT,
    EXP_KANTO_DEX_WEEPINBELL,
    EXP_KANTO_DEX_VICTREEBEL,
    EXP_KANTO_DEX_TENTACOOL,
    EXP_KANTO_DEX_TENTACRUEL,
    EXP_KANTO_DEX_GEODUDE,
    EXP_KANTO_DEX_GRAVELER,
    EXP_KANTO_DEX_GOLEM,
    EXP_KANTO_DEX_PONYTA,
    EXP_KANTO_DEX_RAPIDASH,
    EXP_KANTO_DEX_SLOWPOKE,
    EXP_KANTO_DEX_SLOWBRO,
    EXP_KANTO_DEX_SLOWKING,
    EXP_KANTO_DEX_MAGNEMITE,
    EXP_KANTO_DEX_MAGNETON,
    EXP_KANTO_DEX_MAGNEZONE,
    EXP_KANTO_DEX_FARFETCHD,
    EXP_KANTO_DEX_DODUO,
    EXP_KANTO_DEX_DODRIO,
    EXP_KANTO_DEX_SEEL,
    EXP_KANTO_DEX_DEWGONG,
    EXP_KANTO_DEX_GRIMER,
    EXP_KANTO_DEX_MUK,
    EXP_KANTO_DEX_SHELLDER,
    EXP_KANTO_DEX_CLOYSTER,
    EXP_KANTO_DEX_GASTLY,
    EXP_KANTO_DEX_HAUNTER,
    EXP_KANTO_DEX_GENGAR,
    EXP_KANTO_DEX_ONIX,
    EXP_KANTO_DEX_STEELIX,
    EXP_KANTO_DEX_DROWZEE,
    EXP_KANTO_DEX_HYPNO,
    EXP_KANTO_DEX_KRABBY,
    EXP_KANTO_DEX_KINGLER,
    EXP_KANTO_DEX_VOLTORB,
    EXP_KANTO_DEX_ELECTRODE,
    EXP_KANTO_DEX_EXEGGCUTE,
    EXP_KANTO_DEX_EXEGGUTOR,
    EXP_KANTO_DEX_CUBONE,
    EXP_KANTO_DEX_MAROWAK,
    EXP_KANTO_DEX_TYROGUE,
    EXP_KANTO_DEX_HITMONLEE,
    EXP_KANTO_DEX_HITMONCHAN,
    EXP_KANTO_DEX_HITMONTOP,
    EXP_KANTO_DEX_LICKITUNG,
    EXP_KANTO_DEX_LICKILICKY,
    EXP_KANTO_DEX_KOFFING,
    EXP_KANTO_DEX_WEEZING,
    EXP_KANTO_DEX_RHYHORN,
    EXP_KANTO_DEX_RHYDON,
    EXP_KANTO_DEX_RHYPERIOR,
    EXP_KANTO_DEX_HAPPINY,
    EXP_KANTO_DEX_CHANSEY,
    EXP_KANTO_DEX_BLISSEY,
    EXP_KANTO_DEX_TANGELA,
    EXP_KANTO_DEX_TANGROWTH,
    EXP_KANTO_DEX_KANGASKHAN,
    EXP_KANTO_DEX_HORSEA,
    EXP_KANTO_DEX_SEADRA,
    EXP_KANTO_DEX_KINGDRA,
    EXP_KANTO_DEX_GOLDEEN,
    EXP_KANTO_DEX_SEAKING,
    EXP_KANTO_DEX_STARYU,
    EXP_KANTO_DEX_STARMIE,
    EXP_KANTO_DEX_MIME_JR,
    EXP_KANTO_DEX_MR_MIME,
    EXP_KANTO_DEX_SCYTHER,
    EXP_KANTO_DEX_SCIZOR,
    EXP_KANTO_DEX_SMOOCHUM,
    EXP_KANTO_DEX_JYNX,
    EXP_KANTO_DEX_ELEKID,
    EXP_KANTO_DEX_ELECTABUZZ,
    EXP_KANTO_DEX_ELECTIVIRE,
    EXP_KANTO_DEX_MAGBY,
    EXP_KANTO_DEX_MAGMAR,
    EXP_KANTO_DEX_MAGMORTAR,
    EXP_KANTO_DEX_PINSIR,
    EXP_KANTO_DEX_TAUROS,
    EXP_KANTO_DEX_MAGIKARP,
    EXP_KANTO_DEX_GYARADOS,
    EXP_KANTO_DEX_LAPRAS,
    EXP_KANTO_DEX_DITTO,
    EXP_KANTO_DEX_EEVEE,
    EXP_KANTO_DEX_VAPOREON,
    EXP_KANTO_DEX_JOLTEON,
    EXP_KANTO_DEX_FLAREON,
    EXP_KANTO_DEX_ESPEON,
    EXP_KANTO_DEX_UMBREON,
    EXP_KANTO_DEX_LEAFEON,
    EXP_KANTO_DEX_GLACEON,
    EXP_KANTO_DEX_SYLVEON,
    EXP_KANTO_DEX_PORYGON,
    EXP_KANTO_DEX_PORYGON2,
    EXP_KANTO_DEX_PORYGON_Z,
    EXP_KANTO_DEX_OMANYTE,
    EXP_KANTO_DEX_OMASTAR,
    EXP_KANTO_DEX_KABUTO,
    EXP_KANTO_DEX_KABUTOPS,
    EXP_KANTO_DEX_AERODACTYL,
    EXP_KANTO_DEX_MUNCHLAX,
    EXP_KANTO_DEX_SNORLAX,
    EXP_KANTO_DEX_ARTICUNO,
    EXP_KANTO_DEX_ZAPDOS,
    EXP_KANTO_DEX_MOLTRES,
    EXP_KANTO_DEX_DRATINI,
    EXP_KANTO_DEX_DRAGONAIR,
    EXP_KANTO_DEX_DRAGONITE,
    EXP_KANTO_DEX_MEWTWO,
    EXP_KANTO_DEX_MEW,
};

#define EXP_KANTO_DEX_COUNT EXP_KANTO_DEX_MEW
