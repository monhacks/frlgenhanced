...
#define SPECIES_TO_EXP_KANTO(name)				[SPECIES_##name - 1] = EXP_KANTO_DEX_##name
#define SPECIES_FORM_TO_EXP_KANTO(name, form)	[SPECIES_##name##_##form - 1] = EXP_KANTO_DEX_##name
#define SPECIES_TO_NATIONAL(name)				[SPECIES_##name - 1] = NATIONAL_DEX_##name
#define SPECIES_FORM_TO_NATIONAL(name, form)	[SPECIES_##name##_##form - 1] = NATIONAL_DEX_##name
#define EXP_KANTO_TO_NATIONAL(name)				[EXP_KANTO_DEX_##name - 1] = NATIONAL_DEX_##name
...
// To reorder the pokedex, see the values in include/constants/pokedex.h.
 ...
 // Assigns all species to the Expanded Kanto Dex Index (Summary No. for Expanded Kanto Dex)
static const u16 sSpeciesToExpandedKantoPokedexNum[NUM_SPECIES - 1] =
{
    SPECIES_TO_EXP_KANTO(BULBASAUR),
    SPECIES_TO_EXP_KANTO(IVYSAUR),
    SPECIES_TO_EXP_KANTO(VENUSAUR),
    SPECIES_FORM_TO_EXP_KANTO(VENUSAUR, MEGA),
    SPECIES_TO_EXP_KANTO(CHARMANDER),
    SPECIES_TO_EXP_KANTO(CHARMELEON),
    SPECIES_TO_EXP_KANTO(CHARIZARD),
    SPECIES_FORM_TO_EXP_KANTO(CHARIZARD, MEGA_X),
    SPECIES_FORM_TO_EXP_KANTO(CHARIZARD, MEGA_Y),
    SPECIES_TO_EXP_KANTO(SQUIRTLE),
    SPECIES_TO_EXP_KANTO(WARTORTLE),
    SPECIES_TO_EXP_KANTO(BLASTOISE),
    SPECIES_FORM_TO_EXP_KANTO(BLASTOISE, MEGA),
    SPECIES_TO_EXP_KANTO(CATERPIE),
    SPECIES_TO_EXP_KANTO(METAPOD),
    SPECIES_TO_EXP_KANTO(BUTTERFREE),
    SPECIES_TO_EXP_KANTO(WEEDLE),
    SPECIES_TO_EXP_KANTO(KAKUNA),
    SPECIES_TO_EXP_KANTO(BEEDRILL),
    SPECIES_FORM_TO_EXP_KANTO(BEEDRILL, MEGA),
    SPECIES_TO_EXP_KANTO(PIDGEY),
    SPECIES_TO_EXP_KANTO(PIDGEOTTO),
    SPECIES_TO_EXP_KANTO(PIDGEOT),
    SPECIES_FORM_TO_EXP_KANTO(PIDGEOT, MEGA),
    SPECIES_TO_EXP_KANTO(RATTATA),
    SPECIES_TO_EXP_KANTO(RATICATE),
    SPECIES_TO_EXP_KANTO(SPEAROW),
    SPECIES_TO_EXP_KANTO(FEAROW),
    SPECIES_TO_EXP_KANTO(EKANS),
    SPECIES_TO_EXP_KANTO(ARBOK),
    SPECIES_TO_EXP_KANTO(PICHU),
    SPECIES_TO_EXP_KANTO(PIKACHU),
    SPECIES_TO_EXP_KANTO(RAICHU),
    SPECIES_TO_EXP_KANTO(SANDSHREW),
    SPECIES_TO_EXP_KANTO(SANDSLASH),
    SPECIES_TO_EXP_KANTO(NIDORAN_F),
    SPECIES_TO_EXP_KANTO(NIDORINA),
    SPECIES_TO_EXP_KANTO(NIDOQUEEN),
    SPECIES_TO_EXP_KANTO(NIDORAN_M),
    SPECIES_TO_EXP_KANTO(NIDORINO),
    SPECIES_TO_EXP_KANTO(NIDOKING),
    SPECIES_TO_EXP_KANTO(CLEFFA),
    SPECIES_TO_EXP_KANTO(CLEFAIRY),
    SPECIES_TO_EXP_KANTO(CLEFABLE),
    SPECIES_TO_EXP_KANTO(VULPIX),
    SPECIES_TO_EXP_KANTO(NINETALES),
    SPECIES_TO_EXP_KANTO(IGGLYBUFF),
    SPECIES_TO_EXP_KANTO(JIGGLYPUFF),
    SPECIES_TO_EXP_KANTO(WIGGLYTUFF),
    SPECIES_TO_EXP_KANTO(ZUBAT),
    SPECIES_TO_EXP_KANTO(GOLBAT),
    SPECIES_TO_EXP_KANTO(CROBAT),
    SPECIES_TO_EXP_KANTO(ODDISH),
    SPECIES_TO_EXP_KANTO(GLOOM),
    SPECIES_TO_EXP_KANTO(VILEPLUME),
    SPECIES_TO_EXP_KANTO(BELLOSSOM),
    SPECIES_TO_EXP_KANTO(PARAS),
    SPECIES_TO_EXP_KANTO(PARASECT),
    SPECIES_TO_EXP_KANTO(VENONAT),
    SPECIES_TO_EXP_KANTO(VENOMOTH),
    SPECIES_TO_EXP_KANTO(DIGLETT),
    SPECIES_TO_EXP_KANTO(DUGTRIO),
    SPECIES_TO_EXP_KANTO(MEOWTH),
    SPECIES_TO_EXP_KANTO(PERSIAN),
    SPECIES_TO_EXP_KANTO(PSYDUCK),
    SPECIES_TO_EXP_KANTO(GOLDUCK),
    SPECIES_TO_EXP_KANTO(MANKEY),
    SPECIES_TO_EXP_KANTO(PRIMEAPE),
    SPECIES_TO_EXP_KANTO(GROWLITHE),
    SPECIES_TO_EXP_KANTO(ARCANINE),
    SPECIES_TO_EXP_KANTO(POLIWAG),
    SPECIES_TO_EXP_KANTO(POLIWHIRL),
    SPECIES_TO_EXP_KANTO(POLIWRATH),
    SPECIES_TO_EXP_KANTO(POLITOED),
    SPECIES_TO_EXP_KANTO(ABRA),
    SPECIES_TO_EXP_KANTO(KADABRA),
    SPECIES_TO_EXP_KANTO(ALAKAZAM),
    SPECIES_FORM_TO_EXP_KANTO(ALAKAZAM, MEGA),
    SPECIES_TO_EXP_KANTO(MACHOP),
    SPECIES_TO_EXP_KANTO(MACHOKE),
    SPECIES_TO_EXP_KANTO(MACHAMP),
    SPECIES_TO_EXP_KANTO(BELLSPROUT),
    SPECIES_TO_EXP_KANTO(WEEPINBELL),
    SPECIES_TO_EXP_KANTO(VICTREEBEL),
    SPECIES_TO_EXP_KANTO(TENTACOOL),
    SPECIES_TO_EXP_KANTO(TENTACRUEL),
    SPECIES_TO_EXP_KANTO(GEODUDE),
    SPECIES_TO_EXP_KANTO(GRAVELER),
    SPECIES_TO_EXP_KANTO(GOLEM),
    SPECIES_TO_EXP_KANTO(PONYTA),
    SPECIES_TO_EXP_KANTO(RAPIDASH),
    SPECIES_TO_EXP_KANTO(SLOWPOKE),
    SPECIES_TO_EXP_KANTO(SLOWBRO),
    SPECIES_FORM_TO_EXP_KANTO(SLOWBRO, MEGA),
    SPECIES_TO_EXP_KANTO(SLOWKING),
    SPECIES_TO_EXP_KANTO(MAGNEMITE),
    SPECIES_TO_EXP_KANTO(MAGNETON),
    SPECIES_TO_EXP_KANTO(MAGNEZONE),
    SPECIES_TO_EXP_KANTO(FARFETCHD),
    SPECIES_TO_EXP_KANTO(DODUO),
    SPECIES_TO_EXP_KANTO(DODRIO),
    SPECIES_TO_EXP_KANTO(SEEL),
    SPECIES_TO_EXP_KANTO(DEWGONG),
    SPECIES_TO_EXP_KANTO(GRIMER),
    SPECIES_TO_EXP_KANTO(MUK),
    SPECIES_TO_EXP_KANTO(SHELLDER),
    SPECIES_TO_EXP_KANTO(CLOYSTER),
    SPECIES_TO_EXP_KANTO(GASTLY),
    SPECIES_TO_EXP_KANTO(HAUNTER),
    SPECIES_TO_EXP_KANTO(GENGAR),
    SPECIES_FORM_TO_EXP_KANTO(GENGAR, MEGA),
    SPECIES_TO_EXP_KANTO(ONIX),
    SPECIES_TO_EXP_KANTO(STEELIX),
    SPECIES_FORM_TO_EXP_KANTO(STEELIX, MEGA),
    SPECIES_TO_EXP_KANTO(DROWZEE),
    SPECIES_TO_EXP_KANTO(HYPNO),
    SPECIES_TO_EXP_KANTO(KRABBY),
    SPECIES_TO_EXP_KANTO(KINGLER),
    SPECIES_TO_EXP_KANTO(VOLTORB),
    SPECIES_TO_EXP_KANTO(ELECTRODE),
    SPECIES_TO_EXP_KANTO(EXEGGCUTE),
    SPECIES_TO_EXP_KANTO(EXEGGUTOR),
    SPECIES_TO_EXP_KANTO(CUBONE),
    SPECIES_TO_EXP_KANTO(MAROWAK),
    SPECIES_TO_EXP_KANTO(TYROGUE),
    SPECIES_TO_EXP_KANTO(HITMONLEE),
    SPECIES_TO_EXP_KANTO(HITMONCHAN),
    SPECIES_TO_EXP_KANTO(HITMONTOP),
    SPECIES_TO_EXP_KANTO(LICKITUNG),
    SPECIES_TO_EXP_KANTO(LICKILICKY),
    SPECIES_TO_EXP_KANTO(KOFFING),
    SPECIES_TO_EXP_KANTO(WEEZING),
    SPECIES_TO_EXP_KANTO(RHYHORN),
    SPECIES_TO_EXP_KANTO(RHYDON),
    SPECIES_TO_EXP_KANTO(RHYPERIOR),
    SPECIES_TO_EXP_KANTO(HAPPINY),
    SPECIES_TO_EXP_KANTO(CHANSEY),
    SPECIES_TO_EXP_KANTO(BLISSEY),
    SPECIES_TO_EXP_KANTO(TANGELA),
    SPECIES_TO_EXP_KANTO(TANGROWTH),
    SPECIES_TO_EXP_KANTO(KANGASKHAN),
    SPECIES_FORM_TO_EXP_KANTO(KANGASKHAN, MEGA),
    SPECIES_TO_EXP_KANTO(HORSEA),
    SPECIES_TO_EXP_KANTO(SEADRA),
    SPECIES_TO_EXP_KANTO(KINGDRA),
    SPECIES_TO_EXP_KANTO(GOLDEEN),
    SPECIES_TO_EXP_KANTO(SEAKING),
    SPECIES_TO_EXP_KANTO(STARYU),
    SPECIES_TO_EXP_KANTO(STARMIE),
    SPECIES_TO_EXP_KANTO(MIME_JR),
    SPECIES_TO_EXP_KANTO(MR_MIME),
    SPECIES_TO_EXP_KANTO(SCYTHER),
    SPECIES_TO_EXP_KANTO(SCIZOR),
    SPECIES_FORM_TO_EXP_KANTO(SCIZOR, MEGA),
    SPECIES_TO_EXP_KANTO(SMOOCHUM),
    SPECIES_TO_EXP_KANTO(JYNX),
    SPECIES_TO_EXP_KANTO(ELEKID),
    SPECIES_TO_EXP_KANTO(ELECTABUZZ),
    SPECIES_TO_EXP_KANTO(ELECTIVIRE),
    SPECIES_TO_EXP_KANTO(MAGBY),
    SPECIES_TO_EXP_KANTO(MAGMAR),
    SPECIES_TO_EXP_KANTO(MAGMORTAR),
    SPECIES_TO_EXP_KANTO(PINSIR),
    SPECIES_FORM_TO_EXP_KANTO(PINSIR, MEGA),
    SPECIES_TO_EXP_KANTO(TAUROS),
    SPECIES_TO_EXP_KANTO(MAGIKARP),
    SPECIES_TO_EXP_KANTO(GYARADOS),
    SPECIES_FORM_TO_EXP_KANTO(GYARADOS, MEGA),
    SPECIES_TO_EXP_KANTO(LAPRAS),
    SPECIES_TO_EXP_KANTO(DITTO),
    SPECIES_TO_EXP_KANTO(EEVEE),
    SPECIES_TO_EXP_KANTO(VAPOREON),
    SPECIES_TO_EXP_KANTO(JOLTEON),
    SPECIES_TO_EXP_KANTO(FLAREON),
    SPECIES_TO_EXP_KANTO(ESPEON),
    SPECIES_TO_EXP_KANTO(UMBREON),
    SPECIES_TO_EXP_KANTO(LEAFEON),
    SPECIES_TO_EXP_KANTO(GLACEON),
    SPECIES_TO_EXP_KANTO(SYLVEON),
    SPECIES_TO_EXP_KANTO(PORYGON),
    SPECIES_TO_EXP_KANTO(PORYGON2),
    SPECIES_TO_EXP_KANTO(PORYGON_Z),
    SPECIES_TO_EXP_KANTO(OMANYTE),
    SPECIES_TO_EXP_KANTO(OMASTAR),
    SPECIES_TO_EXP_KANTO(KABUTO),
    SPECIES_TO_EXP_KANTO(KABUTOPS),
    SPECIES_TO_EXP_KANTO(AERODACTYL),
    SPECIES_FORM_TO_EXP_KANTO(AERODACTYL, MEGA),
    SPECIES_TO_EXP_KANTO(MUNCHLAX),
    SPECIES_TO_EXP_KANTO(SNORLAX),
    SPECIES_TO_EXP_KANTO(ARTICUNO),
    SPECIES_TO_EXP_KANTO(ZAPDOS),
    SPECIES_TO_EXP_KANTO(MOLTRES),
    SPECIES_TO_EXP_KANTO(DRATINI),
    SPECIES_TO_EXP_KANTO(DRAGONAIR),
    SPECIES_TO_EXP_KANTO(DRAGONITE),
    SPECIES_TO_EXP_KANTO(MEWTWO),
    SPECIES_FORM_TO_EXP_KANTO(MEWTWO, MEGA_X),
    SPECIES_FORM_TO_EXP_KANTO(MEWTWO, MEGA_Y),
    SPECIES_TO_EXP_KANTO(MEW),
};
...
static const u16 sSpeciesToNationalPokedexNum[NUM_SPECIES - 1] =
{
    ...
    SPECIES_FORM_TO_NATIONAL(ALAKAZAM, MEGA),
    ...
    SPECIES_FORM_TO_NATIONAL(SLOWBRO, MEGA),
    ...
    SPECIES_FORM_TO_NATIONAL(GENGAR, MEGA),
    ...
    SPECIES_FORM_TO_NATIONAL(KANGASKHAN, MEGA),
    ...
    SPECIES_FORM_TO_NATIONAL(AERODACTYL, MEGA),
    ...
    SPECIES_FORM_TO_NATIONAL(MEWTWO, MEGA_X),
    SPECIES_FORM_TO_NATIONAL(MEWTWO, MEGA_Y),
    ...
    SPECIES_FORM_TO_NATIONAL(AMPHAROS, MEGA),
    ...
    SPECIES_FORM_TO_NATIONAL(UNOWN, B),
    SPECIES_FORM_TO_NATIONAL(UNOWN, C),
    SPECIES_FORM_TO_NATIONAL(UNOWN, D),
    SPECIES_FORM_TO_NATIONAL(UNOWN, E),
    SPECIES_FORM_TO_NATIONAL(UNOWN, F),
    SPECIES_FORM_TO_NATIONAL(UNOWN, G),
    SPECIES_FORM_TO_NATIONAL(UNOWN, H),
    SPECIES_FORM_TO_NATIONAL(UNOWN, I),
    SPECIES_FORM_TO_NATIONAL(UNOWN, J),
    SPECIES_FORM_TO_NATIONAL(UNOWN, K),
    SPECIES_FORM_TO_NATIONAL(UNOWN, L),
    SPECIES_FORM_TO_NATIONAL(UNOWN, M),
    SPECIES_FORM_TO_NATIONAL(UNOWN, N),
    SPECIES_FORM_TO_NATIONAL(UNOWN, O),
    SPECIES_FORM_TO_NATIONAL(UNOWN, P),
    SPECIES_FORM_TO_NATIONAL(UNOWN, Q),
    SPECIES_FORM_TO_NATIONAL(UNOWN, R),
    SPECIES_FORM_TO_NATIONAL(UNOWN, S),
    SPECIES_FORM_TO_NATIONAL(UNOWN, T),
    SPECIES_FORM_TO_NATIONAL(UNOWN, U),
    SPECIES_FORM_TO_NATIONAL(UNOWN, V),
    SPECIES_FORM_TO_NATIONAL(UNOWN, W),
    SPECIES_FORM_TO_NATIONAL(UNOWN, X),
    SPECIES_FORM_TO_NATIONAL(UNOWN, Y),
    SPECIES_FORM_TO_NATIONAL(UNOWN, Z),
    SPECIES_FORM_TO_NATIONAL(UNOWN, EMARK),
    SPECIES_FORM_TO_NATIONAL(UNOWN, QMARK),
    ...
    SPECIES_FORM_TO_NATIONAL(HOUNDOOM, MEGA),
    ...
    SPECIES_FORM_TO_NATIONAL(TYRANITAR, MEGA),
    ...
    SPECIES_FORM_TO_NATIONAL(GARDEVOIR, MEGA),
    ...
    SPECIES_FORM_TO_NATIONAL(ALTARIA, MEGA),
    ...
    SPECIES_FORM_TO_NATIONAL(SALAMENCE, MEGA),
    SPECIES_TO_NATIONAL(BELDUM),
    SPECIES_TO_NATIONAL(METANG),
    SPECIES_TO_NATIONAL(METAGROSS),
    SPECIES_FORM_TO_NATIONAL(METAGROSS, MEGA),
    SPECIES_TO_NATIONAL(REGIROCK),
    SPECIES_TO_NATIONAL(REGICE),
    SPECIES_TO_NATIONAL(REGISTEEL),
    SPECIES_TO_NATIONAL(LATIAS),
    SPECIES_FORM_TO_NATIONAL(LATIAS, MEGA),
    SPECIES_TO_NATIONAL(LATIOS),
    SPECIES_FORM_TO_NATIONAL(LATIOS, MEGA),
    SPECIES_TO_NATIONAL(KYOGRE),
    SPECIES_FORM_TO_NATIONAL(KYOGRE, PRIMAL),
    SPECIES_TO_NATIONAL(GROUDON),
    SPECIES_FORM_TO_NATIONAL(GROUDON, PRIMAL),
    SPECIES_TO_NATIONAL(RAYQUAZA),
    SPECIES_FORM_TO_NATIONAL(RAYQUAZA, MEGA),
    SPECIES_TO_NATIONAL(JIRACHI),
    SPECIES_FORM_TO_NATIONAL(DEOXYS, NORMAL),
    SPECIES_FORM_TO_NATIONAL(DEOXYS, ATTACK),
    SPECIES_FORM_TO_NATIONAL(DEOXYS, DEFENSE),
    SPECIES_FORM_TO_NATIONAL(DEOXYS, SPEED),
    ...
    SPECIES_FORM_TO_NATIONAL(BURMY, PLANT_CLOAK),
    SPECIES_FORM_TO_NATIONAL(BURMY, SANDY_CLOAK),
    SPECIES_FORM_TO_NATIONAL(BURMY, TRASH_CLOAK),
    SPECIES_FORM_TO_NATIONAL(WORMADAM, PLANT_CLOAK),
    SPECIES_FORM_TO_NATIONAL(WORMADAM, SANDY_CLOAK),
    SPECIES_FORM_TO_NATIONAL(WORMADAM, TRASH_CLOAK),
    ...
    SPECIES_FORM_TO_NATIONAL(CHERRIM, OVERCAST),
    SPECIES_FORM_TO_NATIONAL(CHERRIM, SUNSHINE),
    SPECIES_FORM_TO_NATIONAL(SHELLOS, WEST_SEA),
    SPECIES_FORM_TO_NATIONAL(SHELLOS, EAST_SEA),
    SPECIES_FORM_TO_NATIONAL(GASTRODON, WEST_SEA),
    SPECIES_FORM_TO_NATIONAL(GASTRODON, EAST_SEA),
    ...
    SPECIES_FORM_TO_NATIONAL(LOPUNNY, MEGA),
    ...
    SPECIES_FORM_TO_NATIONAL(ABOMASNOW, MEGA),
    ...
    SPECIES_FORM_TO_NATIONAL(GALLADE, MEGA),
	SPECIES_TO_NATIONAL(PROBOPASS),
	SPECIES_TO_NATIONAL(DUSKNOIR),
	SPECIES_TO_NATIONAL(FROSLASS),
	SPECIES_TO_NATIONAL(ROTOM),
    SPECIES_FORM_TO_NATIONAL(ROTOM, HEAT),
    SPECIES_FORM_TO_NATIONAL(ROTOM, WASH),
    SPECIES_FORM_TO_NATIONAL(ROTOM, FROST),
    SPECIES_FORM_TO_NATIONAL(ROTOM, FAN),
    SPECIES_FORM_TO_NATIONAL(ROTOM, MOW),
    ...
    SPECIES_FORM_TO_NATIONAL(GIRATINA, ALTERED),
    SPECIES_FORM_TO_NATIONAL(GIRATINA, ORIGIN),
	SPECIES_TO_NATIONAL(CRESSELIA),
	SPECIES_TO_NATIONAL(PHIONE),
	SPECIES_TO_NATIONAL(MANAPHY),
	SPECIES_TO_NATIONAL(DARKRAI),
    SPECIES_FORM_TO_NATIONAL(SHAYMIN, LAND),
    SPECIES_FORM_TO_NATIONAL(SHAYMIN, SKY),
    SPECIES_FORM_TO_NATIONAL(ARCEUS, NORMAL),
    SPECIES_FORM_TO_NATIONAL(ARCEUS, FIRE),
    SPECIES_FORM_TO_NATIONAL(ARCEUS, WATER),
    SPECIES_FORM_TO_NATIONAL(ARCEUS, ELECTRIC),
    SPECIES_FORM_TO_NATIONAL(ARCEUS, GRASS),
    SPECIES_FORM_TO_NATIONAL(ARCEUS, ICE),
    SPECIES_FORM_TO_NATIONAL(ARCEUS, FIGHTING),
    SPECIES_FORM_TO_NATIONAL(ARCEUS, POISON),
    SPECIES_FORM_TO_NATIONAL(ARCEUS, GROUND),
    SPECIES_FORM_TO_NATIONAL(ARCEUS, FLYING),
    SPECIES_FORM_TO_NATIONAL(ARCEUS, PSYCHIC),
    SPECIES_FORM_TO_NATIONAL(ARCEUS, BUG),
    SPECIES_FORM_TO_NATIONAL(ARCEUS, ROCK),
    SPECIES_FORM_TO_NATIONAL(ARCEUS, GHOST),
    SPECIES_FORM_TO_NATIONAL(ARCEUS, DRAGON),
    SPECIES_FORM_TO_NATIONAL(ARCEUS, DARK),
    SPECIES_FORM_TO_NATIONAL(ARCEUS, STEEL),
    SPECIES_FORM_TO_NATIONAL(ARCEUS, FAIRY),
    ...
    SPECIES_FORM_TO_NATIONAL(AUDINO, MEGA),
    ...
    SPECIES_FORM_TO_NATIONAL(BASCULIN, RED_STRIPED),
    SPECIES_FORM_TO_NATIONAL(BASCULIN, BLUE_STRIPED),
	SPECIES_TO_NATIONAL(SANDILE),
	SPECIES_TO_NATIONAL(KROKOROK),
	SPECIES_TO_NATIONAL(KROOKODILE),
	SPECIES_TO_NATIONAL(DARUMAKA),
    SPECIES_FORM_TO_NATIONAL(DARMANITAN, STANDARD_MODE),
    SPECIES_FORM_TO_NATIONAL(DARMANITAN, ZEN_MODE),
    ...
    SPECIES_FORM_TO_NATIONAL(DEERLING, SPRING),
    SPECIES_FORM_TO_NATIONAL(DEERLING, SUMMER),
    SPECIES_FORM_TO_NATIONAL(DEERLING, AUTUMN),
    SPECIES_FORM_TO_NATIONAL(DEERLING, WINTER),
    SPECIES_FORM_TO_NATIONAL(SAWSBUCK, SPRING),
    SPECIES_FORM_TO_NATIONAL(SAWSBUCK, SUMMER),
    SPECIES_FORM_TO_NATIONAL(SAWSBUCK, AUTUMN),
    SPECIES_FORM_TO_NATIONAL(SAWSBUCK, WINTER),
    ...
    SPECIES_FORM_TO_NATIONAL(TORNADUS, INCARNATE),
    SPECIES_FORM_TO_NATIONAL(TORNADUS, THERIAN),
    SPECIES_FORM_TO_NATIONAL(THUNDURUS, INCARNATE),
    SPECIES_FORM_TO_NATIONAL(THUNDURUS, THERIAN),
	SPECIES_TO_NATIONAL(RESHIRAM),
	SPECIES_TO_NATIONAL(ZEKROM),
    SPECIES_FORM_TO_NATIONAL(LANDORUS, INCARNATE),
    SPECIES_FORM_TO_NATIONAL(LANDORUS, THERIAN),
	SPECIES_TO_NATIONAL(KYUREM),
    SPECIES_FORM_TO_NATIONAL(KYUREM, WHITE),
    SPECIES_FORM_TO_NATIONAL(KYUREM, BLACK),
    SPECIES_FORM_TO_NATIONAL(KELDEO, ORDINARY),
    SPECIES_FORM_TO_NATIONAL(KELDEO, RESOLUTE),
    SPECIES_FORM_TO_NATIONAL(MELOETTA, ARIA),
    SPECIES_FORM_TO_NATIONAL(MELOETTA, PIROUETTE),
	SPECIES_TO_NATIONAL(GENESECT),
    SPECIES_FORM_TO_NATIONAL(GENESECT, DOUSE_DRIVE),
    SPECIES_FORM_TO_NATIONAL(GENESECT, SHOCK_DRIVE),
    SPECIES_FORM_TO_NATIONAL(GENESECT, BURN_DRIVE),
    SPECIES_FORM_TO_NATIONAL(GENESECT, CHILL_DRIVE),
    ...
    SPECIES_FORM_TO_NATIONAL(VIVILLON, ICY_SNOW),
    SPECIES_FORM_TO_NATIONAL(VIVILLON, POLAR),
    SPECIES_FORM_TO_NATIONAL(VIVILLON, TUNDRA),
    SPECIES_FORM_TO_NATIONAL(VIVILLON, CONTINENTAL),
    SPECIES_FORM_TO_NATIONAL(VIVILLON, GARDEN),
    SPECIES_FORM_TO_NATIONAL(VIVILLON, ELEGANT),
    SPECIES_FORM_TO_NATIONAL(VIVILLON, MEADOW),
    SPECIES_FORM_TO_NATIONAL(VIVILLON, MODERN),
    SPECIES_FORM_TO_NATIONAL(VIVILLON, MARINE),
    SPECIES_FORM_TO_NATIONAL(VIVILLON, ARCHIPELAGO),
    SPECIES_FORM_TO_NATIONAL(VIVILLON, HIGH_PLAINS),
    SPECIES_FORM_TO_NATIONAL(VIVILLON, SANDSTORM),
    SPECIES_FORM_TO_NATIONAL(VIVILLON, RIVER),
    SPECIES_FORM_TO_NATIONAL(VIVILLON, MONSOON),
    SPECIES_FORM_TO_NATIONAL(VIVILLON, SAVANNA),
    SPECIES_FORM_TO_NATIONAL(VIVILLON, SUN),
    SPECIES_FORM_TO_NATIONAL(VIVILLON, OCEAN),
    SPECIES_FORM_TO_NATIONAL(VIVILLON, JUNGLE),
    SPECIES_FORM_TO_NATIONAL(VIVILLON, FANCY),
    SPECIES_FORM_TO_NATIONAL(VIVILLON, POKE_BALL),
	SPECIES_TO_NATIONAL(LITLEO),
	SPECIES_TO_NATIONAL(PYROAR),
    SPECIES_FORM_TO_NATIONAL(FLABEBE, RED_FLOWER),
    SPECIES_FORM_TO_NATIONAL(FLABEBE, YELLOW_FLOWER),
    SPECIES_FORM_TO_NATIONAL(FLABEBE, ORANGE_FLOWER),
    SPECIES_FORM_TO_NATIONAL(FLABEBE, BLUE_FLOWER),
    SPECIES_FORM_TO_NATIONAL(FLABEBE, WHITE_FLOWER),
    SPECIES_FORM_TO_NATIONAL(FLOETTE, RED_FLOWER),
    SPECIES_FORM_TO_NATIONAL(FLOETTE, YELLOW_FLOWER),
    SPECIES_FORM_TO_NATIONAL(FLOETTE, ORANGE_FLOWER),
    SPECIES_FORM_TO_NATIONAL(FLOETTE, BLUE_FLOWER),
    SPECIES_FORM_TO_NATIONAL(FLOETTE, WHITE_FLOWER),
    SPECIES_FORM_TO_NATIONAL(FLOETTE, ETERNAL_FLOWER),
    SPECIES_FORM_TO_NATIONAL(FLORGES, RED_FLOWER),
    SPECIES_FORM_TO_NATIONAL(FLORGES, YELLOW_FLOWER),
    SPECIES_FORM_TO_NATIONAL(FLORGES, ORANGE_FLOWER),
    SPECIES_FORM_TO_NATIONAL(FLORGES, BLUE_FLOWER),
    SPECIES_FORM_TO_NATIONAL(FLORGES, WHITE_FLOWER),
	SPECIES_TO_NATIONAL(SKIDDO),
	SPECIES_TO_NATIONAL(GOGOAT),
	SPECIES_TO_NATIONAL(PANCHAM),
	SPECIES_TO_NATIONAL(PANGORO),
    SPECIES_FORM_TO_NATIONAL(FURFROU, NATURAL),
    SPECIES_FORM_TO_NATIONAL(FURFROU, HEART_TRIM),
    SPECIES_FORM_TO_NATIONAL(FURFROU, STAR_TRIM),
    SPECIES_FORM_TO_NATIONAL(FURFROU, DIAMOND_TRIM),
    SPECIES_FORM_TO_NATIONAL(FURFROU, DEBUTANTE_TRIM),
    SPECIES_FORM_TO_NATIONAL(FURFROU, MATRON_TRIM),
    SPECIES_FORM_TO_NATIONAL(FURFROU, DANDY_TRIM),
    SPECIES_FORM_TO_NATIONAL(FURFROU, LA_REINE_TRIM),
    SPECIES_FORM_TO_NATIONAL(FURFROU, KABUKI_TRIM),
    SPECIES_FORM_TO_NATIONAL(FURFROU, PHARAOH_TRIM),
	SPECIES_TO_NATIONAL(ESPURR),
    SPECIES_FORM_TO_NATIONAL(MEOWSTIC, MALE),
    SPECIES_FORM_TO_NATIONAL(MEOWSTIC, FEMALE),
	SPECIES_TO_NATIONAL(HONEDGE),
	SPECIES_TO_NATIONAL(DOUBLADE),
    SPECIES_FORM_TO_NATIONAL(AEGISLASH, SHIELD),
    SPECIES_FORM_TO_NATIONAL(AEGISLASH, BLADE),
    ...
    SPECIES_FORM_TO_NATIONAL(PUMPKABOO, AVERAGE),
    SPECIES_FORM_TO_NATIONAL(PUMPKABOO, SMALL),
    SPECIES_FORM_TO_NATIONAL(PUMPKABOO, LARGE),
    SPECIES_FORM_TO_NATIONAL(PUMPKABOO, SUPER),
    SPECIES_FORM_TO_NATIONAL(GOURGEIST, AVERAGE),
    SPECIES_FORM_TO_NATIONAL(GOURGEIST, SMALL),
    SPECIES_FORM_TO_NATIONAL(GOURGEIST, LARGE),
    SPECIES_FORM_TO_NATIONAL(GOURGEIST, SUPER),
	SPECIES_TO_NATIONAL(BERGMITE),
	SPECIES_TO_NATIONAL(AVALUGG),
	SPECIES_TO_NATIONAL(NOIBAT),
	SPECIES_TO_NATIONAL(NOIVERN),
    SPECIES_FORM_TO_NATIONAL(XERNEAS, NEUTRAL),
    SPECIES_FORM_TO_NATIONAL(XERNEAS, ACTIVE),
	SPECIES_TO_NATIONAL(YVELTAL),
	SPECIES_TO_NATIONAL(ZYGARDE),
	SPECIES_TO_NATIONAL(DIANCIE),
    SPECIES_FORM_TO_NATIONAL(DIANCIE, MEGA),
    SPECIES_FORM_TO_NATIONAL(HOOPA, CONFINED),
    SPECIES_FORM_TO_NATIONAL(HOOPA, UNBOUND),
	SPECIES_TO_NATIONAL(VOLCANION),
};

// Assigns all Expanded Kanto Dex Indexes to a National Dex Index
static const u16 sExpandedKantoToNationalOrder[NUM_SPECIES - 1] =
{
    EXP_KANTO_TO_NATIONAL(BULBASAUR),
    EXP_KANTO_TO_NATIONAL(IVYSAUR),
    EXP_KANTO_TO_NATIONAL(VENUSAUR),
    EXP_KANTO_TO_NATIONAL(CHARMANDER),
    EXP_KANTO_TO_NATIONAL(CHARMELEON),
    EXP_KANTO_TO_NATIONAL(CHARIZARD),
    EXP_KANTO_TO_NATIONAL(SQUIRTLE),
    EXP_KANTO_TO_NATIONAL(WARTORTLE),
    EXP_KANTO_TO_NATIONAL(BLASTOISE),
    EXP_KANTO_TO_NATIONAL(CATERPIE),
    EXP_KANTO_TO_NATIONAL(METAPOD),
    EXP_KANTO_TO_NATIONAL(BUTTERFREE),
    EXP_KANTO_TO_NATIONAL(WEEDLE),
    EXP_KANTO_TO_NATIONAL(KAKUNA),
    EXP_KANTO_TO_NATIONAL(BEEDRILL),
    EXP_KANTO_TO_NATIONAL(PIDGEY),
    EXP_KANTO_TO_NATIONAL(PIDGEOTTO),
    EXP_KANTO_TO_NATIONAL(PIDGEOT),
    EXP_KANTO_TO_NATIONAL(RATTATA),
    EXP_KANTO_TO_NATIONAL(RATICATE),
    EXP_KANTO_TO_NATIONAL(SPEAROW),
    EXP_KANTO_TO_NATIONAL(FEAROW),
    EXP_KANTO_TO_NATIONAL(EKANS),
    EXP_KANTO_TO_NATIONAL(ARBOK),
    EXP_KANTO_TO_NATIONAL(PICHU),
    EXP_KANTO_TO_NATIONAL(PIKACHU),
    EXP_KANTO_TO_NATIONAL(RAICHU),
    EXP_KANTO_TO_NATIONAL(SANDSHREW),
    EXP_KANTO_TO_NATIONAL(SANDSLASH),
    EXP_KANTO_TO_NATIONAL(NIDORAN_F),
    EXP_KANTO_TO_NATIONAL(NIDORINA),
    EXP_KANTO_TO_NATIONAL(NIDOQUEEN),
    EXP_KANTO_TO_NATIONAL(NIDORAN_M),
    EXP_KANTO_TO_NATIONAL(NIDORINO),
    EXP_KANTO_TO_NATIONAL(NIDOKING),
    EXP_KANTO_TO_NATIONAL(CLEFFA),
    EXP_KANTO_TO_NATIONAL(CLEFAIRY),
    EXP_KANTO_TO_NATIONAL(CLEFABLE),
    EXP_KANTO_TO_NATIONAL(VULPIX),
    EXP_KANTO_TO_NATIONAL(NINETALES),
    EXP_KANTO_TO_NATIONAL(IGGLYBUFF),
    EXP_KANTO_TO_NATIONAL(JIGGLYPUFF),
    EXP_KANTO_TO_NATIONAL(WIGGLYTUFF),
    EXP_KANTO_TO_NATIONAL(ZUBAT),
    EXP_KANTO_TO_NATIONAL(GOLBAT),
    EXP_KANTO_TO_NATIONAL(CROBAT),
    EXP_KANTO_TO_NATIONAL(ODDISH),
    EXP_KANTO_TO_NATIONAL(GLOOM),
    EXP_KANTO_TO_NATIONAL(VILEPLUME),
    EXP_KANTO_TO_NATIONAL(BELLOSSOM),
    EXP_KANTO_TO_NATIONAL(PARAS),
    EXP_KANTO_TO_NATIONAL(PARASECT),
    EXP_KANTO_TO_NATIONAL(VENONAT),
    EXP_KANTO_TO_NATIONAL(VENOMOTH),
    EXP_KANTO_TO_NATIONAL(DIGLETT),
    EXP_KANTO_TO_NATIONAL(DUGTRIO),
    EXP_KANTO_TO_NATIONAL(MEOWTH),
    EXP_KANTO_TO_NATIONAL(PERSIAN),
    EXP_KANTO_TO_NATIONAL(PSYDUCK),
    EXP_KANTO_TO_NATIONAL(GOLDUCK),
    EXP_KANTO_TO_NATIONAL(MANKEY),
    EXP_KANTO_TO_NATIONAL(PRIMEAPE),
    EXP_KANTO_TO_NATIONAL(GROWLITHE),
    EXP_KANTO_TO_NATIONAL(ARCANINE),
    EXP_KANTO_TO_NATIONAL(POLIWAG),
    EXP_KANTO_TO_NATIONAL(POLIWHIRL),
    EXP_KANTO_TO_NATIONAL(POLIWRATH),
    EXP_KANTO_TO_NATIONAL(POLITOED),
    EXP_KANTO_TO_NATIONAL(ABRA),
    EXP_KANTO_TO_NATIONAL(KADABRA),
    EXP_KANTO_TO_NATIONAL(ALAKAZAM),
    EXP_KANTO_TO_NATIONAL(MACHOP),
    EXP_KANTO_TO_NATIONAL(MACHOKE),
    EXP_KANTO_TO_NATIONAL(MACHAMP),
    EXP_KANTO_TO_NATIONAL(BELLSPROUT),
    EXP_KANTO_TO_NATIONAL(WEEPINBELL),
    EXP_KANTO_TO_NATIONAL(VICTREEBEL),
    EXP_KANTO_TO_NATIONAL(TENTACOOL),
    EXP_KANTO_TO_NATIONAL(TENTACRUEL),
    EXP_KANTO_TO_NATIONAL(GEODUDE),
    EXP_KANTO_TO_NATIONAL(GRAVELER),
    EXP_KANTO_TO_NATIONAL(GOLEM),
    EXP_KANTO_TO_NATIONAL(PONYTA),
    EXP_KANTO_TO_NATIONAL(RAPIDASH),
    EXP_KANTO_TO_NATIONAL(SLOWPOKE),
    EXP_KANTO_TO_NATIONAL(SLOWBRO),
    EXP_KANTO_TO_NATIONAL(SLOWKING),
    EXP_KANTO_TO_NATIONAL(MAGNEMITE),
    EXP_KANTO_TO_NATIONAL(MAGNETON),
    EXP_KANTO_TO_NATIONAL(MAGNEZONE),
    EXP_KANTO_TO_NATIONAL(FARFETCHD),
    EXP_KANTO_TO_NATIONAL(DODUO),
    EXP_KANTO_TO_NATIONAL(DODRIO),
    EXP_KANTO_TO_NATIONAL(SEEL),
    EXP_KANTO_TO_NATIONAL(DEWGONG),
    EXP_KANTO_TO_NATIONAL(GRIMER),
    EXP_KANTO_TO_NATIONAL(MUK),
    EXP_KANTO_TO_NATIONAL(SHELLDER),
    EXP_KANTO_TO_NATIONAL(CLOYSTER),
    EXP_KANTO_TO_NATIONAL(GASTLY),
    EXP_KANTO_TO_NATIONAL(HAUNTER),
    EXP_KANTO_TO_NATIONAL(GENGAR),
    EXP_KANTO_TO_NATIONAL(ONIX),
    EXP_KANTO_TO_NATIONAL(STEELIX),
    EXP_KANTO_TO_NATIONAL(DROWZEE),
    EXP_KANTO_TO_NATIONAL(HYPNO),
    EXP_KANTO_TO_NATIONAL(KRABBY),
    EXP_KANTO_TO_NATIONAL(KINGLER),
    EXP_KANTO_TO_NATIONAL(VOLTORB),
    EXP_KANTO_TO_NATIONAL(ELECTRODE),
    EXP_KANTO_TO_NATIONAL(EXEGGCUTE),
    EXP_KANTO_TO_NATIONAL(EXEGGUTOR),
    EXP_KANTO_TO_NATIONAL(CUBONE),
    EXP_KANTO_TO_NATIONAL(MAROWAK),
    EXP_KANTO_TO_NATIONAL(TYROGUE),
    EXP_KANTO_TO_NATIONAL(HITMONLEE),
    EXP_KANTO_TO_NATIONAL(HITMONCHAN),
    EXP_KANTO_TO_NATIONAL(HITMONTOP),
    EXP_KANTO_TO_NATIONAL(LICKITUNG),
    EXP_KANTO_TO_NATIONAL(LICKILICKY),
    EXP_KANTO_TO_NATIONAL(KOFFING),
    EXP_KANTO_TO_NATIONAL(WEEZING),
    EXP_KANTO_TO_NATIONAL(RHYHORN),
    EXP_KANTO_TO_NATIONAL(RHYDON),
    EXP_KANTO_TO_NATIONAL(RHYPERIOR),
    EXP_KANTO_TO_NATIONAL(HAPPINY),
    EXP_KANTO_TO_NATIONAL(CHANSEY),
    EXP_KANTO_TO_NATIONAL(BLISSEY),
    EXP_KANTO_TO_NATIONAL(TANGELA),
    EXP_KANTO_TO_NATIONAL(TANGROWTH),
    EXP_KANTO_TO_NATIONAL(KANGASKHAN),
    EXP_KANTO_TO_NATIONAL(HORSEA),
    EXP_KANTO_TO_NATIONAL(SEADRA),
    EXP_KANTO_TO_NATIONAL(KINGDRA),
    EXP_KANTO_TO_NATIONAL(GOLDEEN),
    EXP_KANTO_TO_NATIONAL(SEAKING),
    EXP_KANTO_TO_NATIONAL(STARYU),
    EXP_KANTO_TO_NATIONAL(STARMIE),
    EXP_KANTO_TO_NATIONAL(MIME_JR),
    EXP_KANTO_TO_NATIONAL(MR_MIME),
    EXP_KANTO_TO_NATIONAL(SCYTHER),
    EXP_KANTO_TO_NATIONAL(SCIZOR),
    EXP_KANTO_TO_NATIONAL(SMOOCHUM),
    EXP_KANTO_TO_NATIONAL(JYNX),
    EXP_KANTO_TO_NATIONAL(ELEKID),
    EXP_KANTO_TO_NATIONAL(ELECTABUZZ),
    EXP_KANTO_TO_NATIONAL(ELECTIVIRE),
    EXP_KANTO_TO_NATIONAL(MAGBY),
    EXP_KANTO_TO_NATIONAL(MAGMAR),
    EXP_KANTO_TO_NATIONAL(MAGMORTAR),
    EXP_KANTO_TO_NATIONAL(PINSIR),
    EXP_KANTO_TO_NATIONAL(TAUROS),
    EXP_KANTO_TO_NATIONAL(MAGIKARP),
    EXP_KANTO_TO_NATIONAL(GYARADOS),
    EXP_KANTO_TO_NATIONAL(LAPRAS),
    EXP_KANTO_TO_NATIONAL(DITTO),
    EXP_KANTO_TO_NATIONAL(EEVEE),
    EXP_KANTO_TO_NATIONAL(VAPOREON),
    EXP_KANTO_TO_NATIONAL(JOLTEON),
    EXP_KANTO_TO_NATIONAL(FLAREON),
    EXP_KANTO_TO_NATIONAL(ESPEON),
    EXP_KANTO_TO_NATIONAL(UMBREON),
    EXP_KANTO_TO_NATIONAL(LEAFEON),
    EXP_KANTO_TO_NATIONAL(GLACEON),
    EXP_KANTO_TO_NATIONAL(SYLVEON),
    EXP_KANTO_TO_NATIONAL(PORYGON),
    EXP_KANTO_TO_NATIONAL(PORYGON2),
    EXP_KANTO_TO_NATIONAL(PORYGON_Z),
    EXP_KANTO_TO_NATIONAL(OMANYTE),
    EXP_KANTO_TO_NATIONAL(OMASTAR),
    EXP_KANTO_TO_NATIONAL(KABUTO),
    EXP_KANTO_TO_NATIONAL(KABUTOPS),
    EXP_KANTO_TO_NATIONAL(AERODACTYL),
    EXP_KANTO_TO_NATIONAL(MUNCHLAX),
    EXP_KANTO_TO_NATIONAL(SNORLAX),
    EXP_KANTO_TO_NATIONAL(ARTICUNO),
    EXP_KANTO_TO_NATIONAL(ZAPDOS),
    EXP_KANTO_TO_NATIONAL(MOLTRES),
    EXP_KANTO_TO_NATIONAL(DRATINI),
    EXP_KANTO_TO_NATIONAL(DRAGONAIR),
    EXP_KANTO_TO_NATIONAL(DRAGONITE),
    EXP_KANTO_TO_NATIONAL(MEWTWO),
    EXP_KANTO_TO_NATIONAL(MEW),
};
    ...
    for (cmdIndex = 0; cmdIndex < ITEM_EFFECT_ARG_START; cmdIndex++)
    {
        ...
        case 4:
            ...
            if (val & ITEM4_PP_UP)
            {
                ...
                if (dataUnsigned < 3 && i > 4)
                {
                    dataUnsigned = GetMonData(mon, MON_DATA_PP_BONUSES, NULL) + gPPUpAddValues[moveIndex];
                    SetMonData(mon, MON_DATA_PP_BONUSES, &dataUnsigned);

                    dataUnsigned = CalculatePPWithBonus(GetMonData(mon, MON_DATA_MOVE1 + moveIndex, NULL), dataUnsigned, moveIndex) - i;
                ...
                if (val & 1)
                {
                    ...
                    case 1: // ITEM4_EV_ATK
						...
						if (evChange > 0)	// Increasing EV (HP or Atk)
						{
							...
							if (itemEffect[idx] == ITEM6_ADD_EV)
							...
							if (dataSigned + evChange > evCap)
								temp = evCap - (dataSigned + evChange) + evChange;
							else
								temp = evChange;
							
							if (evCount + temp > MAX_TOTAL_EVS)
								temp += MAX_TOTAL_EVS - (evCount + temp);
                    ...
                    case 2: // ITEM4_HEAL_HP
                        ...
                        if (GetMonData(mon, MON_DATA_MAX_HP, NULL) != GetMonData(mon, MON_DATA_HP, NULL))
                        {
                            if (!usedByAI)
                            {
                                ...
                                {
                                    gBattleMons[battleMonId].hp = dataUnsigned;
                    ...
                    case 3: // ITEM4_HEAL_PP
                        if (!(val & (ITEM4_HEAL_PP_ONE >> 3)))
                        {
                            ...
                            for (r5 = 0; r5 < MAX_MON_MOVES; r5++)
                            {
                                ...
                                if (dataUnsigned != CalculatePPWithBonus(move_id, GetMonData(mon, MON_DATA_PP_BONUSES, NULL), r5))
                                {
                                    dataUnsigned += itemEffect[idx];
                                    move_id = GetMonData(mon, MON_DATA_MOVE1 + r5, NULL);
                                    if (dataUnsigned > CalculatePPWithBonus(move_id, GetMonData(mon, MON_DATA_PP_BONUSES, NULL), r5))
                                    {
                                        move_id = GetMonData(mon, MON_DATA_MOVE1 + r5, NULL);
                                        dataUnsigned = CalculatePPWithBonus(move_id, GetMonData(mon, MON_DATA_PP_BONUSES, NULL), r5);
                                    }
                                    ...
                                    if (gMain.inBattle && battleMonId != MAX_BATTLERS_COUNT && MOVE_IS_PERMANENT(battleMonId, r5))
                                        gBattleMons[battleMonId].pp[r5] = dataUnsigned;
                        ...
                        else
                        {
                            ...
                            if (dataUnsigned != CalculatePPWithBonus(move_id, GetMonData(mon, MON_DATA_PP_BONUSES, NULL), moveIndex))
                            {
                                dataUnsigned += itemEffect[idx++];
                                move_id = GetMonData(mon, MON_DATA_MOVE1 + moveIndex, NULL);
                                if (dataUnsigned > CalculatePPWithBonus(move_id, GetMonData(mon, MON_DATA_PP_BONUSES, NULL), moveIndex))
                                {
                                    move_id = GetMonData(mon, MON_DATA_MOVE1 + moveIndex, NULL);
                                    dataUnsigned = CalculatePPWithBonus(move_id, GetMonData(mon, MON_DATA_PP_BONUSES, NULL), moveIndex);
                                }
                                SetMonData(mon, MON_DATA_PP1 + moveIndex, &dataUnsigned);
                                
                                // Heal battler PP too (if applicable)
                                if (gMain.inBattle && battleMonId != MAX_BATTLERS_COUNT && MOVE_IS_PERMANENT(battleMonId, moveIndex))
                                    gBattleMons[battleMonId].pp[moveIndex] = dataUnsigned;
        ...
        case 5:
            ...
            while (val != 0)
            {
                if (val & 1)
                {
                    ...
                    case 4: // ITEM5_PP_MAX
                        dataUnsigned = (GetMonData(mon, MON_DATA_PP_BONUSES, NULL) & gPPUpGetMask[moveIndex]) >> (moveIndex * 2);
                        temp = CalculatePPWithBonus(GetMonData(mon, MON_DATA_MOVE1 + moveIndex, NULL), GetMonData(mon, MON_DATA_PP_BONUSES, NULL), moveIndex);
                        
                        // Check if 3 PP Ups have been applied already, and that the move has a total PP of at least 5 (excludes Sketch)
                        if (dataUnsigned < 3 && temp >= 5)
                        {
                            ...
                            SetMonData(mon, MON_DATA_PP_BONUSES, &dataUnsigned);
                            dataUnsigned = CalculatePPWithBonus(GetMonData(mon, MON_DATA_MOVE1 + moveIndex, NULL), dataUnsigned, moveIndex) - temp;
                            dataUnsigned = GetMonData(mon, MON_DATA_PP1 + moveIndex, NULL) + dataUnsigned;
                            SetMonData(mon, MON_DATA_PP1 + moveIndex, &dataUnsigned);
                            retVal = FALSE;
                        }
...
u16 ExpandedKantoToNationalOrder(u16 expKantoNum)
{
    ...
    return sExpandedKantoToNationalOrder[expKantoNum - 1];
}

u16 SpeciesToCryId(u16 species)
{
	if (sSpeciesIdToCryId[species] >= CRY_COUNT)
		return CRY_NONE;
