...
const u8 gText_MenuInGameTime[] = _("{STR_VAR_1}:{STR_VAR_2}");
...
const u8 gText_WallClock[] = _("View clock");
...
const u8 gText_Bicycle_Price[] = _("BICYCLE{CLEAR_TO 0x49}{FONT_SMALL}¥10,000,000");
const u8 gText_NoThanks[] = _("NO THANKS");
const u8 gText_Abra_150Coins[] = _("ABRA{CLEAR_TO 0x55}{FONT_SMALL} 150 COINS");
const u8 gText_Clefairy_600Coins[] = _("CLEFAIRY{CLEAR_TO 0x55}{FONT_SMALL} 600 COINS");
const u8 gText_Pinsir_3000Coins[] = _("PINSIR{CLEAR_TO 0x4B}{FONT_SMALL} 3,000 COINS");
const u8 gText_Scyther_3000Coins[] = _("SCYTHER{CLEAR_TO 0x4B}{FONT_SMALL} 3,000 COINS");
const u8 gText_Dratini_5000Coins[] = _("DRATINI{CLEAR_TO 0x4B}{FONT_SMALL} 5,000 COINS");
...
const u8 gText_PokeSum_MetInATrade_HiddenNature[] = _("{DYNAMIC 0x00} ({DYNAMIC 0x03}) nature.\nMet in a trade.");
const u8 gText_PokeSum_FatefulEncounterMet[] = _("{DYNAMIC 0x00} nature.\nMet in a fateful encounter when\nat {LV_2} {DYNAMIC 0x01}.");
const u8 gText_PokeSum_FatefulEncounterMet_HiddenNature[] = _("{DYNAMIC 0x00} ({DYNAMIC 0x03}) nature.\nMet in a fateful encounter when\nat {LV_2} {DYNAMIC 0x01}.");
const u8 gText_PokeSum_Met[] = _("{DYNAMIC 0x00} nature.\nMet in {DYNAMIC 0x02} at {LV_2} {DYNAMIC 0x01}.");
const u8 gText_PokeSum_Met_HiddenNature[] = _("{DYNAMIC 0x00} ({DYNAMIC 0x03}) nature.\nMet in {DYNAMIC 0x02} at {LV_2} {DYNAMIC 0x01}.");
const u8 gText_PokeSum_ApparentlyMet[] = _("{DYNAMIC 0x00} nature.\nApparently met in {DYNAMIC 0x02}\nat {LV_2} {DYNAMIC 0x01}.");
const u8 gText_PokeSum_ApparentlyMet_HiddenNature[] = _("{DYNAMIC 0x00} ({DYNAMIC 0x03}) nature.\nApparently met in {DYNAMIC 0x02}\nat {LV_2} {DYNAMIC 0x01}.");
const u8 gText_PokeSum_Hatched[] = _("{DYNAMIC 0x00} nature.\nHatched: {DYNAMIC 0x02}\nat {LV_2} {DYNAMIC 0x01}.");
const u8 gText_PokeSum_Hatched_HiddenNature[] = _("{DYNAMIC 0x00} ({DYNAMIC 0x03}) nature.\nHatched: {DYNAMIC 0x02}\nat {LV_2} {DYNAMIC 0x01}.");
...
const u8 gText_PokeSum_FatefulEncounterHatched_HiddenNature[] = _("{DYNAMIC 0x00} ({DYNAMIC 0x03}) nature. Met in a fateful\nencounter (hatched: {DYNAMIC 0x02}\nat {LV_2} {DYNAMIC 0x01}).");
...
const u8 gText_PokeSum_ApparentlyFatefulEncounterHatched_HiddenNature[] = _("{DYNAMIC 0x00} ({DYNAMIC 0x03}) nature. Apparently met in\na fateful encounter (hatched:\n{DYNAMIC 0x02} at {LV_2} {DYNAMIC 0x01}).");
